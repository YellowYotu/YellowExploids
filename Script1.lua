...
-- === Установка или обновление Skybox с тролл-сканером
...
local versionLabel = Instance.new("TextLabel", soonFrame)
versionLabel.Size = UDim2.new(0, 160, 0, 20)
versionLabel.Position = UDim2.new(1, -180, 0, 10)
versionLabel.BackgroundTransparency = 1
versionLabel.Text = "Skybox Version 1.0"
...
versionMain.Text = "YellowExploits Version 2.2.0"
...
local function startFling()
    ...
    -- Вращение с BodyAngularVelocity
    local bav = Instance.new("BodyAngularVelocity")
    bav.MaxTorque = Vector3.new(1e5, 1e5, 1e5)
    bav.AngularVelocity = Vector3.new(50, 50, 50) -- вращение вокруг всех осей
    bav.Parent = flingPart

    -- Движение вверх с BodyVelocity
